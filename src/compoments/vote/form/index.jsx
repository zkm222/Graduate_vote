      ...
      <div>
        <div className={styles.form}>
          <div className={styles.need}>
            ...
            <p className={styles.foots}>5．勤奋学习，刻苦钻研，成绩优秀。研究生支教团推免生综合测评成绩底线应与所在学科普通类推免生综合测评成绩底线保持一致；学校认定的基地班专业学生不受排名限制。<br />
              大学英语四级成绩在425分（含）以上，其它语种学生大学外语四级成绩需合格（仅限东北师范大学考点，其它考点无效）；或东北师范大学英语水平测试成绩达到70分(含)以上。<br />
              体育类、艺术类学生申报研究生支教团的，其专业排名、外语水平等要求与申请所在学科普通类推免保持一致。</p>
